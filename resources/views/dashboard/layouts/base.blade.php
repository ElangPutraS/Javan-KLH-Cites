        ...
        <div class="scrollbar-inner">
            ...
            @can('access-pelaku-usaha')
                @if(auth()->user()->company->company_status >0)
                    <!-- Menu Pelaku Usaha -->
                        <li class="navigation__sub @if(Request::segment(1)=='submission') navigation__sub--active navigation__sub--toggled @endif">
                            <a href="{{ route('user.submission.index') }}"><i
                                        class="zmdi zmdi-collection-text zmdi-hc-fw"></i>Permohonan SATS-LN</a>
                            <ul>
                        ...
                        <li @if(Request::segment(1)=='renewal') class="navigation__active" @endif><a
                                    href="{{ route('user.renewal.index') }}"><i
                                        class="zmdi zmdi-refresh-alt zmdi-hc-fw"></i> Pembaharuan SATS-LN </a></li>
