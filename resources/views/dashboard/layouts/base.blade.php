    ...
    <aside class="sidebar">
        <div class="scrollbar-inner">
            ...
            <ul class="navigation">
                ...
                <li @if(Request::segment(2)=='categories') class="navigation__active" @endif><a href="{{ route('admin.species.category') }}"><i class="zmdi zmdi-nature-people zmdi-hc-fw"></i> Kelola Kategori Spesies</a></li>
