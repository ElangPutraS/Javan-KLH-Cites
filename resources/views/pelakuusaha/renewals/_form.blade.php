<div class="form-group">
    ...
    <div class="col-sm-14">
        <div class="btn-group btn-group--colors" data-toggle="buttons" id="is_renewal">
            <label class="btn bg-light-blue waves-effect"><input type="radio" id="is_renewal1" name="is_renewal"
                                                                 value="1" autocomplete="off" required></label>Ya &nbsp;&nbsp;&nbsp;
            <label class="btn bg-red waves-effect"><input type="radio" id="is_renewal2" name="is_renewal" value="0"
                                                          autocomplete="off" required></label>Tidak
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-14">
        <div class="btn-group btn-group--colors" data-toggle="buttons" id="is_blanko">
            <label class="btn bg-light-blue waves-effect"><input type="radio" id="is_blanko1" name="is_blanko" value="1"
                                                                 autocomplete="off" required></label>Ya &nbsp;&nbsp;&nbsp;
            <label class="btn bg-red waves-effect"><input type="radio" id="is_blanko2" name="is_blanko" value="0"
                                                          autocomplete="off" required></label>Tidak
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <input type="text" name="name" class="form-control"
                   value="{{ old('name', array_get($user->company, 'owner_name')) }}" readonly>
        </div>
        <div class="col-sm-6">
...
<div class="form-group">
    <div class="row">
        <div class="col-sm-6">
            ...
            <input type="text" name="npwp_number_user" class="form-control"
                   value="{{ old('npwp_number_user', array_get($user->userProfile, 'npwp_number')) }}" readonly>
        </div>
        <div class="col-sm-6">
            <label class="control-label">Nomor NPWP Perusahaan</label>
            <input type="text" name="npwp_number" class="form-control"
                   value="{{ old('npwp_number', array_get($user->company, 'npwp_number')) }}" readonly>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <input type="text" name="company_address" class="form-control"
                   value="{{ old('company_address', array_get($user->company, 'company_address')) }}" readonly>
        </div>
        <div class="col-sm-6">
            <label class="control-label">Alamat Penangkaran</label>
            <input type="text" name="captivity_address" class="form-control"
                   value="{{ old('captivity_address', array_get($user->company, 'captivity_address')) }}" readonly>
        </div>
    </div>
</div>
...
<div class="form-group">
    <div class="row">
        <div class="col-sm-6">
            ...
            <input type="text" name="date_distribution" class="form-control"
                   value="{{ Carbon\Carbon::parse($user->company->date_distribution)->toFormattedDateString() }}"
                   readonly>
        </div>
        <div class="col-sm-6">
            <label class="control-label">Nomor Kontak</label>
            <input type="text" name="mobile" class="form-control"
                   value="{{ old('mobile', array_get($user->userProfile, 'mobile')) }}" readonly>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <input type="text" id="consignee" name="consignee" class="form-control"
                   value="{{ old('consignee', array_get($trade_permit, 'consignee')) }}" required>
        </div>
        <div class="col-sm-6">
            <label class="control-label">Alamat Penerima</label>
            <textarea name="consignee_address" id="consignee_address" class="form-control"
                      required>{{ old('consignee_address', array_get($trade_permit, 'consignee_address')) }}</textarea>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-14">
        <input type="text" name="appendix_type" class="form-control"
               value="@if($trade_permit->appendix_type == 'EA') {{'SATS-LN Site (EA)'}} @else {{'SATS-LN Non Site (EB)'}} @endif"
               readonly>
    </div>
</div>
        ...
        <div class="table-responsive">
            ...
            <table id="data-table" class="table table-bordered">
                ...
                @foreach($trade_permit->tradeSpecies as $species)
                    @if ($species->pivot->total_exported  > 0)
                        <tr>
                            <td><?=$no++?></td>
