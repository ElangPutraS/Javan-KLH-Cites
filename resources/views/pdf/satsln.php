<table>
	<tr>
		...
		<td rowspan="2">&nbsp;</td>
		<td>KEMENTERIAN LINGKUNGAN HIDUP DAN KEHUTANAN DIREKTORAT JENDERAL KONSERVASI SUMBER DAYA ALAM DAN EKOSISTEM
</td>
		<td rowspan="2">&nbsp;</td>
	</tr>
	<tr>
		<td>MINISTRY OF ENVIRONMENT AND FORESTRY DIRECTORATE GENERAL OF ECOSYSTEM AND NATURAL RESOURCES CONSERVATION
</td>
	</tr>
	...
	<tr>
		<td>
			<table>
				<tr>
					<td>VI.</td>
					<td>Pemegang sertifikat ini diberi izin untuk mengekspor/mengimpor satwa dan tumbuhan sebagai berikut<hr><i>The above mentioned permitee is authorized to export/import the wild animals and plants specifiedhere order</i></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td>
			<table>
				<tr>
					<td>X.</td>
					<td>Sertifikat ini diterbitkan oleh<hr><i>This permitt is issued by</i></td>
				</tr>
			</table>
		</td>
